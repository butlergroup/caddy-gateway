## Caddy Gateway API & Helm Chart Version v0.2.72 (09-26-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.71 (09-04-2026)

#### New Features

#### Improvements

- Updated github.com/go-openapi/jsonpointer from v1.0.0 to v1.0.1 through automated dependency management
- Updated github.com/go-openapi/jsonreference from v1.0.1 to v1.0.2 through automated dependency management
- Updated github.com/google/pprof from v0.0.0-20260902005441-ca85771921e4 to v0.0.0-20260903180319-d6c3cb2f37ec through automated dependency management
- Updated sigs.k8s.io/controller-runtime from v0.24.1 to v0.25.0 through automated dependency management
- Updated sigs.k8s.io/gateway-api from v1.6.1 to v1.6.2 through automated dependency management
...
## Caddy Gateway API & Helm Chart Version v0.2.70 (09-03-2026)

#### New Features

#### Improvements

- Updated golang.org/x/crypto from v0.55.0 to v0.56.0 through automated dependency management
- chore: Update go.mod dependencies
...
## Caddy Gateway API & Helm Chart Version v0.2.69 (09-02-2026)

#### New Features

#### Improvements

- Updated github.com/google/pprof from v0.0.0-20260830191439-4932ad3515ea to v0.0.0-20260902005441-ca85771921e4 through automated dependency management
- chore: Update go.mod dependencies
...
- Updated github.com/prometheus/procfs from v0.21.1 to v0.22.0 through automated dependency management
- chore: Update go.mod dependencies
...
## Caddy Gateway API & Helm Chart Version v0.2.66 (08-27-2026)

#### New Features

#### Improvements

- Updated k8s.io/api from v0.36.4 to v0.37.0 through automated dependency management
- Updated k8s.io/apiextensions-apiserver from v0.36.4 to v0.37.0 through automated dependency management
- Updated k8s.io/apimachinery from v0.36.4 to v0.37.0 through automated dependency management
- Updated k8s.io/client-go from v0.36.4 to v0.37.0 through automated dependency management
- chore: Update go.mod dependencies
...
## Caddy Gateway API & Helm Chart Version v0.2.65 (08-26-2026)

#### New Features

#### Improvements

- Updated github.com/go-openapi/jsonreference from v1.0.0 to v1.0.1 through automated dependency management
- Updated github.com/google/pprof from v0.0.0-20260825002013-8a176773c324 to v0.0.0-20260825171938-4d453200e7d9 through automated dependency management
- Updated go.opentelemetry.io/otel from v1.45.0 to v1.46.0 through automated dependency management
- Updated go.opentelemetry.io/otel/metric from v1.45.0 to v1.46.0 through automated dependency management
- Updated go.opentelemetry.io/otel/trace from v1.45.0 to v1.46.0 through automated dependency management
- chore: Update go.mod dependencies
...
## Caddy Gateway API & Helm Chart Version v0.2.56 (08-13-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.55 (08-12-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.50 (08-02-2026)

#### New Features

#### Improvements

- Updated github.com/google/pprof from v0.0.0-20260709232956-b9395ee17fa0 to v0.0.0-20260802004507-5106ece31595 through automated dependency management
- chore: Update go.mod dependencies
...
## Caddy Gateway API & Helm Chart Version v0.2.49 (07-28-2026)
...
- Updated k8s.io/apiextensions-apiserver from v0.36.2 to v0.36.3 through automated dependency management
...
- Updated k8s.io/kube-openapi from v0.0.0-20260706235625-cdb1db5517a0 to v0.0.0-20260718133925-74c0ba7c0470 through automated dependency management
- chore: Update go.mod dependencies
...
## Caddy Gateway API & Helm Chart Version v0.2.41 (07-17-2026)

#### New Features

#### Improvements

- Updated sigs.k8s.io/gateway-api from v1.6.0 to v1.6.1 through automated dependency management
- chore: Update go.mod dependencies
...
## Caddy Gateway API & Helm Chart Version v0.2.40 (07-11-2026)

#### New Features

#### Improvements

- Updated github.com/prometheus/common from v0.69.0 to v0.70.0 through automated dependency management
- chore: Update go.mod dependencies
...
## Caddy Gateway API & Helm Chart Version v0.2.39 (07-10-2026)

#### New Features

#### Improvements

- Updated github.com/google/pprof from v0.0.0-20260604005048-7023385849c0 to v0.0.0-20260709232956-b9395ee17fa0 through automated dependency management
- chore: Update go.mod dependencies
...
- Updated sigs.k8s.io/gateway-api from v1.5.1 to v1.6.0 through automated dependency management
- chore: Update go.mod dependencies
...
## Caddy Gateway API & Helm Chart Version v0.2.32 (06-29-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.31 (06-28-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.30 (06-27-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.29 (06-26-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.28 (06-24-2026)
...
- Updated github.com/onsi/ginkgo/v2 from v2.30.0 to v2.31.0 through automated dependency management
- chore: Update go.mod dependencies
...
## Caddy Gateway API & Helm Chart Version v0.2.23 (06-13-2026)
...
- Updated k8s.io/apiextensions-apiserver from v0.36.1 to v0.36.2 through automated dependency management
...
## Caddy Gateway API & Helm Chart Version v0.2.22 (06-12-2026)

#### New Features

#### Improvements

- Updated github.com/onsi/ginkgo/v2 from v2.29.0 to v2.30.0 through automated dependency management
...
## Caddy Gateway API & Helm Chart Version v0.2.21 (06-11-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.20 (06-09-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.19 (06-08-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.17 (06-03-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.16 (06-03-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.15 (06-01-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.14 (05-30-2026)
...
## Caddy Gateway API & Helm Chart Version v0.2.13 (05-29-2026)
